  ...
  return (
    <div className='bg-login'>
      <div className="h-screen bg-cover flex items-center justify-center">
        <div className='flex flex-col max-w-md justify-center mx-auto w-full bg-white-800 bg-opacity-80'>
          <h1 className='text-black text-3xl mb-10'>Sign Up</h1>
          <form className='flex flex-col mx-auto' onSubmit={handleSubmit}>
            ...
            <input type='text' placeholder='Username' onChange={handleChange} name='username' value={formValues.username} className='my-4 bg-transparent border-b-2 text-black outline-none' required />
            ...
            <input type='password' placeholder='Confirm Password' onChange={handleChange} name='confirmPassword' value={formValues.confirmPassword} className='my-4 bg-transparent border-b-2 text-black outline-none' required />
