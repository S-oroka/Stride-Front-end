...
const Navbar = ({ user, handleLogout }) => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-4 bg-slate-700">
      <div className="text-2xl ml-5 text-white">Stride</div>
      ...
      {user ? (
        <>
          <ul className="hidden md:flex items-center">
            ...
            <li
              className="px-4 cursor-pointer capitalize font-medium text-white hover:scale-105 duration-150"
          ...
          {nav && (
            <ul className="flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-blugraye-500 text-gray-500">
              <li
